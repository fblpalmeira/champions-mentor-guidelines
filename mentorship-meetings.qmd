...
-   Possible areas to think about:
    ...
    - *For a package sent to review:* prepare the package to sent to the review process, send the package to review and complete the process. Improve functions, testing, documentation, repository, functionalities, governance. Write a paper for JOSS or JOSE about the package. Improve the review process (accessibility, languages, guidelines)
